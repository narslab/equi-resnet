# -*- coding: utf-8 -*-
"""
Created on Tue Apr 18 12:33:32 2023
...
pv_demog['invincome_norm'] = (pv_demog['invincome']-pv_demog['invincome'] .min()) / (pv_demog['invincome'].max()-pv_demog['invincome'] .min())
...
nodes_centrality=nodes_centrality.rename(columns={0: "osmid", 1: "ec"})
...
pv_nodes_centrality_demog_joint['w_ec_pden']=pv_nodes_centrality_demog_joint['ec']*pv_nodes_centrality_demog_joint['popden_norm']
pv_nodes_centrality_demog_joint['w_ec_invinc']=pv_nodes_centrality_demog_joint['ec']*pv_nodes_centrality_demog_joint['invincome_norm']
pv_nodes_centrality_demog_joint['w_ec_both']=pv_nodes_centrality_demog_joint['ec']*(0.5*pv_nodes_centrality_demog_joint['invincome_norm']+0.5*pv_nodes_centrality_demog_joint['popden_norm'])

# Save the merged DataFrame to a CSV file
#pv_nodes_centrality_demog_joint.to_csv('eigenvector-centrality.csv')
pv_nodes_centrality_demog_joint.to_file('eigenvector-centrality.shp', driver='ESRI Shapefile')